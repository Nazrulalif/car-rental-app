...
import com.example.rental_mobil.databinding.ActivityBookingConfirmationBinding
...
class BookingKonfirmasiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b.bookingBiayaSopir.setText("RM "+result_sopir)
        ...
        FirebaseFirestore.getInstance().collection("mobil")
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    b.bookingHarga.setText("Biaya Rental RM "+st4)

                    val hr = hr.toInt()
                    val hrgMobil = hr * hrgM
                    b.bookingHargaRental.setText("RM "+hrgMobil)
                    totalMobil = hrgMobil.toString()

                    if (idS == "") {
                        b.bookingTotal.setText("RM "+totalMobil)
                        ...
                        b.bookingTotal.setText("RM "+totalAkhir.toString())
