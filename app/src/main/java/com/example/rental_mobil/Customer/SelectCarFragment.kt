...
import com.example.rental_mobil.databinding.FragmentSelectCarBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.squareup.picasso.Picasso

class SelectCarFragment : Fragment() {
    private lateinit var b: FragmentSelectCarBinding
    lateinit var v : View
    ...
    override fun onCreateView(
        ...
        b = FragmentSelectCarBinding.inflate(layoutInflater)
        v = b.root
    ...
    class AdapterMobil(val dataMobil: List<HashMap<String,String>>, val parent: BookingActivity) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderDataMobil {
            val v = LayoutInflater.from(parent.context).inflate(R.layout.row_select_car, parent, false)
        ...
        override fun onBindViewHolder(holder: HolderDataMobil, position: Int) {
            ...
            holder.hrg.setText("RM."+data.get("harga"))
