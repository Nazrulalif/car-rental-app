...
import com.example.rental_mobil.databinding.FragmentCarDetailCustomerBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.squareup.picasso.Picasso

class CarDetailFragment : DialogFragment() {
    private lateinit var b: FragmentCarDetailCustomerBinding
    lateinit var v: View
    ...
    override fun onCreateView(
        ...
        b = FragmentCarDetailCustomerBinding.inflate(layoutInflater)
        v = b.root
        ...
        FirebaseFirestore.getInstance().collection("mobil")
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    b.detailCategory.setText("Kategori : "+st3)
                    b.detailMerk.setText("Merek : "+st4)
                    b.detailHarga.setText("Harga Rental RM "+st9)
