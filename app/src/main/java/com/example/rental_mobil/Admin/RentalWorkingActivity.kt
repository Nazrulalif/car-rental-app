...
import com.example.rental_mobil.Adapter.AdapterRentalWorking
import com.example.rental_mobil.R
import com.example.rental_mobil.databinding.ActivityRentalAdminHistoryBinding
import com.google.firebase.firestore.FirebaseFirestore

class RentalWorkingActivity : AppCompatActivity() {
    private lateinit var b: ActivityRentalAdminHistoryBinding

    val dataRental = mutableListOf<HashMap<String,String>>()
    lateinit var rentalAdp : AdapterRentalWorking

    lateinit var db: FirebaseFirestore

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        b = ActivityRentalAdminHistoryBinding.inflate(layoutInflater)
        setContentView(b.root)
        supportActionBar?.setTitle("Daftar Mobil Berjalan")
        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        rentalAdp = AdapterRentalWorking(dataRental, this)
