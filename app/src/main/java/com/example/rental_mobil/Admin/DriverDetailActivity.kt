...
import com.example.rental_mobil.databinding.ActivityDriverDetailBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.squareup.picasso.Picasso

class DriverDetailActivity : AppCompatActivity() {
    private lateinit var b: ActivityDriverDetailBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        b = ActivityDriverDetailBinding.inflate(layoutInflater)
        ...
        FirebaseFirestore.getInstance().collection("sopir")
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    b.detailName.setText(st2)
                    b.detailIc.setText("NIK : "+st3)
                    ...
                    b.detailAddress.setText("Alamat : "+st9)
