...
import com.example.rental_mobil.databinding.FragmentRentalAdminReturnBinding
import com.google.firebase.firestore.FirebaseFirestore
import java.text.SimpleDateFormat
import java.util.Date
import java.util.HashMap

class RentalReturnFragment : DialogFragment() {
    private lateinit var b: FragmentRentalAdminReturnBinding
    lateinit var v: View
    ...
    override fun onCreateView(
        ...
        b = FragmentRentalAdminReturnBinding.inflate(layoutInflater)
        v = b.root
