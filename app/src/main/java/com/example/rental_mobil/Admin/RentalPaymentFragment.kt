...
import com.example.rental_mobil.databinding.FragmentRentalAdminPaymentBinding
...
class RentalPaymentFragment : DialogFragment() {
    private lateinit var b: FragmentRentalAdminPaymentBinding
    lateinit var v: View
    ...
    override fun onCreateView(
        ...
        b = FragmentRentalAdminPaymentBinding.inflate(layoutInflater)
        v = b.root
