...
import com.example.rental_mobil.Admin.RentalWorkingActivity
import com.example.rental_mobil.Admin.RentalDetailActivity
import com.example.rental_mobil.R

class AdapterRentalWorking (val dataRental: List<HashMap<String,String>>, val parent: RentalWorkingActivity) :
    RecyclerView.Adapter<AdapterRentalWorking.HolderDataRental>(){
